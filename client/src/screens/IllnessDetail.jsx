    ...
    <div className="illness-detail">
      <div className="illness-cards">
        ...
        <div>
          {currentUser ? (
            <>
              <Link to={`/symptom/new/${illnessItem?.id}`}>
                <button className="button">Add a Symptom</button>
              </Link>
            </>
          ) : (
            ""
      ...
      {illnessItem?.symptoms.map((symptom) => (
        <div className="symptom-card">
          <React.Fragment key={symptom.id}>
            <p className="symptom-description" key={symptom.id}>
              {symptom.description}
            </p>
            <>
           
              <Link to={`/symptom/edit/${symptom.id}`}>
                <button className="edit">edit</button>
              </Link>
              <button className="edit" onClick={() => handleDelete(symptom.id)}>
                delete
              </button>
            </>
          </React.Fragment>
